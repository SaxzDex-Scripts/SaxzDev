...
do
    ...
    function a.b()
        ...
        local j = "https://raw.githubusercontent.com/Tataontop05/Icons/main/Main-v2.lua"
                ...
                for x, z in pairs(v.Properties or {}) do
                    ...
                    if A ~= nil then
                        if typeof(A) == "Color3" then
                            local B = v.Object:FindFirstChild "SaxzhubGradient"
                            if B then
                                B:Destroy()
                            end
        ...
        function p.Image(v, x, B, C, F, G, H, J)
            ...
            elseif string.find(v, "http") then
                local M = "Saxzhub/" .. C .. "/assets/." .. F .. "-" .. x .. ".png"
                local N, O =
                    pcall(
                    function()
                        task.spawn(
                            function()
                                ...
                                if O then
                                    ...
                                    warn(
                                        string.format(
                                            "[ Saxzhub.Creator ] Failed to load custom asset '%s': %s",
                                            M,
                                            tostring(P)
                                        )
                                    )
                ...
                if not N then
                    warn(
                        "[ Saxzhub.Creator ]  '" .. identifyexecutor() .. "' doesnt support the URL Images. Error: " .. O
                    )
    ...
    function a.e()
        ...
        local function Z(f)
            ...
            return w(
                y(g[1], 4) ..
                    y(g[2], 4) .. y(g[3], 4) .. y(g[4], 4) .. y(g[5], 4) .. y(g[6], 4) .. y(g[7], 4) .. y(g[8], 4)
            )
        end
        local f
        local g = {["\\"] = "\\", ['"'] = '"', ["\b"] = "b", ["\f"] = "f", ["\n"] = "n", ["\r"] = "r", ["\t"] = "t"}
        ...
        local x = {["nil"] = p, table = r, string = u, number = v, boolean = tostring}
        f = function(B, C)
            local F = type(B)
            local G = x[F]
            if G then
        ...
        local R = function(R, S)
            ...
            while U <= #R do
                ...
                elseif W == 92 then
                    ...
                    if X == "u" then
                        local Y =
                            R:match("^[dD][89aAbB]%x%x\\u%x%x%x%x", U + 1) or R:match("^%x%x%x%x", U + 1) or
                            O(R, U - 1, "invalid unicode escape in string")
                        T = T .. Q(Y)
                        U = U + #Y
                    else
                        if not J[X] then
        ...
        function ab.New(ad, ae)
            ...
            local aj = false
            local ak, al, am, an, ao, ap, aq, ar, as =
    ...
    function a.f()
        ...
        function ac.New(ad)
            ...
            function ValidateKey(ah)
                local ai =
                    "https://pandadevelopment.net/v2_validation?key=" ..
                    tostring(ah) .. "&service=" .. tostring(ad) .. "&hwid=" .. tostring(ae())
                    ...
                    if ak.Success then
                        ...
                        warn(
                            "[Pelinda Ov2.5] HTTP request was not successful. Code: " ..
                                tostring(ak.StatusCode) .. " Message: " .. ak.StatusMessage
                        )
        ...
        return [[
{
    ...
    "version": "1.6.62",
    "main": "./dist/main.lua",
    "repository": "https://github.com/Tataontop05/Saxzhub",
        ...
        function aa.New(ae, af, ag, ah, ai, aj, ak, al)
            ...
            local ao =
                ...
                },
                {
                    ...
                    ab.NewRoundFrame(
                        am,
                        not ak and "SquircleOutline" or "SquircleOutline2",
                        {
                            ThemeTag = {
                        ...
                        },
                        {
                            ...
                            ac(
                                "TextLabel",
                                {
                                    ...
                                    TextColor3 = ah == "Primary" and Color3.new(1, 1, 1) or
                                        ah == "White" and Color3.new(0, 0, 0) or
                                        nil,
                                    AutomaticSize = "XY",
                                    TextSize = 18
                                }
    ...
    function a.k()
        ...
        function aa.New(ae, af, ag, ah, ai, aj, ak, al)
            ...
            if aj then
                ab.AddSignal(
                    ap:GetPropertyChangedSignal "Text",
                    function()
                        if ai then
            ...
            if not ae then
                ag.UIElements.FullScreen =
                    ...
                    "Frame",
                    {
                        ...
                        Visible = false,
                        Parent = ad.Parent or
                            (Window and Window.UIElements and Window.UIElements.Main and Window.UIElements.Main.Main)
                    },
                    {
                        ab(
                            "UICorner",
    ...
    function a.m()
        ...
        function aa.new(ag, ah, ai, aj)
            local ak = a.load "l".Init(nil, ag.Saxzhub.ScreenGui.KeySystem)
            ...
            if ag.KeySystem.API then
                ...
                for d, f in next, ag.KeySystem.API do
                    local g = ag.Saxzhub.Services[f.Type]
                    if g then
                        local h = {}
            ...
            local aA =
                ...
                function()
                    ...
                    elseif not ag.KeySystem.API then
                        local aC =
                            type(ag.KeySystem.Key) == "table" and table.find(ag.KeySystem.Key, aA) or
                            ag.KeySystem.Key == aA
    ...
    function a.o()
        ...
        return function(ag)
            ...
            ab.AddSignal(
                ak:GetPropertyChangedSignal "AbsolutePosition",
                function()
                    ai(ak)
                end
            )
            ...
            ab.AddSignal(
                ak:GetPropertyChangedSignal "AbsoluteSize",
                function()
                    ai(ak)
                end
            )
            ...
            ah.AddParent = function(al)
                ab.AddSignal(
                    al:GetPropertyChangedSignal "Visible",
                    function()
    ...
    function a.r()
        ...
        function aa.new(ae)
            ...
            local ag = a.load "l".Init(nil, ae.Saxzhub.ScreenGui.Popups)
    ...
    function a.u()
        ...
        function aa.New(af, ag, ah, ai)
                ...
                function(ao)
                    if
                        (ao.UserInputType == Enum.UserInputType.MouseButton1 or
                            ao.UserInputType == Enum.UserInputType.Touch)
                     then
                    ...
                    if
                     ...
                     then
                        ...
                        ap =
                            ...
                            function(ar)
                                if
                                    ar.UserInputType == Enum.UserInputType.MouseMovement or
                                        ar.UserInputType == Enum.UserInputType.Touch
                                 then
                        ...
                        aq =
                            ...
                            function(ar)
                                if
                                    ar.UserInputType == Enum.UserInputType.MouseButton1 or
                                        ar.UserInputType == Enum.UserInputType.Touch
                                 then
                                    am = false
                                    if ap then
            ...
            ac.AddSignal(
                af:GetPropertyChangedSignal "AbsoluteWindowSize",
                function()
                    updateSliderSize()
                    updateThumbPosition()
                end
            ...
            ac.AddSignal(
                af:GetPropertyChangedSignal "AbsoluteCanvasSize",
                function()
                    updateSliderSize()
                    updateThumbPosition()
                end
            ...
            ac.AddSignal(
                af:GetPropertyChangedSignal "CanvasPosition",
                function()
                    if not am then
                        updateThumbPosition()
                    end
    ...
    function a.w()
        ...
        function ad.Init(ae, af)
            if not af.Folder then
                warn "[ Saxzhub.ConfigManager ] Window.Folder is not specified."
                return false
            end

            ac = af
            ad.Folder = ac.Folder
            ad.Path = "Saxzhub/" .. tostring(ad.Folder) .. "/config/"

            if not isfolder("Saxzhub/" .. ad.Folder) then
                makefolder("Saxzhub/" .. ad.Folder)
                if not isfolder("Saxzhub/" .. ad.Folder .. "/config/") then
                    makefolder("Saxzhub/" .. ad.Folder .. "/config/")
                end
            end
                ...
                local aj, ak =
                    ...
                    function()
                        local aj = readfile or function()
                                warn "[ Saxzhub.ConfigManager ] The config system doesn't work in the studio."
                                return nil
                            end
                ...
                if ai and aj and aj.__autoload then
                    ...
                    task.spawn(
                        function()
                            ...
                            if ak then
                                if ac.Debug then
                                    print("[ Saxzhub.ConfigManager ] AutoLoaded config: " .. af)
                                end
                            else
                                warn(
                                    "[ Saxzhub.ConfigManager ] Failed to AutoLoad config: " ..
                                        af .. " - " .. tostring(al)
                                )
                            end
                        end
    ...
    function a.x()
        ...
        function aa.New(af)
            ...
            ab.AddSignal(
                am:GetPropertyChangedSignal "AbsoluteSize",
                function()
    ...
    function a.z()
        ...
        return function(af)
            ...
            local function CreateText(an, ao)
                local ap =
                    typeof(ag.Color) == "string" and GetTextColorForHSB(Color3.fromHex(aa.Colors[ag.Color])) or
                    typeof(ag.Color) == "Color3" and GetTextColorForHSB(ag.Color)
                ...
                return ab(
                    "TextLabel",
                    {
                        ...
                        FontFace = Font.new(
                            aa.Font,
                            ao == "Desc" and Enum.FontWeight.Medium or Enum.FontWeight.SemiBold
                        )
                    }
                )
            end
            ...
            local aC, aD =
                ...
                "Squircle",
                {
                    ...
                    ImageColor3 = ag.Color and
                        (typeof(ag.Color) == "string" and Color3.fromHex(aa.Colors[ag.Color]) or
                            typeof(ag.Color) == "Color3" and ag.Color) or
                        nil
                },
                {
                    ag.UIElements.Container,
                            ...
                            aa.AddSignal(
                                ...
                                function(aE, aF)
                                    aA.HoverGradient.Offset =
                                        Vector2.new(((aE - aC.AbsolutePosition.X) / aC.AbsoluteSize.X) - 0.5, 0)
                                    ay.HoverGradient.Offset =
                                        Vector2.new(((aE - aC.AbsolutePosition.X) / aC.AbsoluteSize.X) - 0.5, 0)
                                end
                            )
                        end
            ...
            function ag.Colorize(aE, aF, b)
                if ag.Color then
                    aF[b] =
                        typeof(ag.Color) == "string" and GetTextColorForHSB(Color3.fromHex(aa.Colors[ag.Color])) or
                        typeof(ag.Color) == "Color3" and GetTextColorForHSB(ag.Color) or
                        nil
                end
            end
            ...
            if af.ElementTable then
                aa.AddSignal(
                    an:GetPropertyChangedSignal "Text",
                    function()
                ...
                aa.AddSignal(
                    ao:GetPropertyChangedSignal "Text",
                    function()
            ...
            function ag.SetThumbnail(aE, aF, b)
                ...
                if al then
                    if aF then
                        al:Destroy()
                        al =
                            aa.Image(aF, ag.Title, ag.UICorner - 3, af.Window.Folder, "Thumbnail", false, ag.IconThemed)
                        al.Size = UDim2.new(1, 0, 0, ai)
            ...
            function ag.UpdateShape(aE)
                if af.Window.NewElements then
                    local aF
                    if af.ParentConfig and af.ParentConfig.ParentType == "Group" then
                        aF = "Squircle"
                    else
                        aF = getElementPosition(aE.Elements, ag.Index)
                    end

                    if aF and aC and aD and at and ax and av and aB and az then
                        aD:SetType(aF)
                        at:SetType(aF)
                        ax:SetType(aF)
        ...
        function ac.New(ae, af)
            ...
            if af.Buttons and #af.Buttons > 0 then
                ...
                for aj, ak in next, af.Buttons do
                    local al =
                        ad(ak.Title, ak.Icon, ak.Callback, "White", ai, nil, nil, af.Window.NewElements and 12 or 10)
    ...
    function a.B()
        ...
        function ac.New(ad, ae)
            ...
            af.UIElements.ButtonIcon.Parent =
                af.Justify == "Between" and af.ButtonFrame.UIElements.Main or
                af.ButtonFrame.UIElements.Container.TitleFrame
            ...
            aa.AddSignal(
                af.ButtonFrame.UIElements.Main.MouseButton1Click,
                function()
                    if ag then
                        task.spawn(
                            function()
            ...
            function am.Animate(av, aw, ax)
                if not al.Window.IsToggleDragging then
                    ...
                    ar =
                        ...
                        function(aC)
                            if
                                al.Window.IsToggleDragging and
                                    (aC.UserInputType == Enum.UserInputType.MouseMovement or
                                        aC.UserInputType == Enum.UserInputType.Touch)
                             then
                                if aB then
                                    return
                                end
                    ...
                    as =
                        ae.InputEnded:Connect(
                        function(aC)
                            if
                                al.Window.IsToggleDragging and
                                    (aC.UserInputType == Enum.UserInputType.MouseButton1 or
                                        aC.UserInputType == Enum.UserInputType.Touch)
                             then
                                al.Window.IsToggleDragging = false
    ...
    function a.F()
        ...
        function ag.New(ai, aj)
                        ...
                        },
                        {
                            ad.NewRoundFrame(
                                ...
                                "Squircle",
                                {
                                    Size = UDim2.new(
                                        0,
                                        aj.Window.NewElements and (ak.ThumbSize * 2) or (ak.ThumbSize + 2),
                                        0,
                                        aj.Window.NewElements and (ak.ThumbSize + 4) or (ak.ThumbSize + 2)
                                    ),
                                    Position = UDim2.new(1, 0, 0.5, 0),
                                    AnchorPoint = Vector2.new(0.5, 0.5),
                                    ThemeTag = {
                ...
                },
                {
                    ae(
                        "UIListLayout",
                        {
                            ...
                            FillDirection = "Horizontal",
                            VerticalAlignment = "Center",
                            HorizontalAlignment = ak.Icons and
                                (ak.Icons.From and (ak.Icons.To and "Center" or "Left") or ak.Icons.To and "Right") or
                                "Center"
                        }
                    ),
                    at,
            ...
            function ak.Set(ay, az, aA)
                if ar then
                    if
                        not ak.IsFocusing and not ah and
                            (not aA or
                                (aA.UserInputType == Enum.UserInputType.MouseButton1 or
                                    aA.UserInputType == Enum.UserInputType.Touch))
                     then
                        if aA then
                            ...
                            am =
                                ac.RenderStepped:Connect(
                                function()
                                    local aD = al and aA.Position.X or aa:GetMouseLocation().X
                                    local aE =
                                        math.clamp(
                                        (aD - ak.UIElements.SliderIcon.AbsolutePosition.X) /
                                            ak.UIElements.SliderIcon.AbsoluteSize.X,
                                        0,
                                        1
                                    )
                                    ...
                                    if
                                     ...
                                     then
                                        ...
                                        if aj.Window.NewElements then
                                            af(
                                                ak.UIElements.SliderIcon.Frame.Thumb,
                                                .2,
                                                {
                                                    ImageTransparency = 0,
                                                    Size = UDim2.new(
                                                        0,
                                                        aj.Window.NewElements and (ak.ThumbSize * 2) or
                                                            (ak.ThumbSize + 2),
                                                        0,
                                                        aj.Window.NewElements and (ak.ThumbSize + 4) or
                                                            (ak.ThumbSize + 2)
                                                    )
                                                },
                                                Enum.EasingStyle.Quint,
                            ...
                            local aB =
                                math.clamp(
                                (az - (ak.Value.Min or 0)) / ((ak.Value.Max or 100) - (ak.Value.Min or 0)),
                                0,
                                1
                            )
            ...
            ad.AddSignal(
                ak.UIElements.SliderContainer.TextBox.FocusLost,
                function(ay)
                    if ay then
            ...
            ad.AddSignal(
                ak.UIElements.SliderContainer.InputBegan,
                function(ay)
                    ...
                    if
                        ay.UserInputType == Enum.UserInputType.MouseButton1 or
                            ay.UserInputType == Enum.UserInputType.Touch
                     then
                        if aj.Window.NewElements then
                            af(
                                ak.UIElements.SliderIcon.Frame.Thumb,
                                .24,
                                {
                                    ...
                                    Size = UDim2.new(
                                        0,
                                        (aj.Window.NewElements and (ak.ThumbSize * 2) or (ak.ThumbSize)) + 8,
                                        0,
                                        ak.ThumbSize + 8
                                    )
                                },
    ...
    function a.G()
        ...
        function ag.New(ai, aj)
            ...
            ad.AddSignal(
                ak.KeybindFrame.UIElements.Main.MouseButton1Click,
                function()
                    if al then
                        if ak.CanChange then
                            ...
                            am =
                                ...
                                function(an)
                                    ...
                                    local ap
                                    ap =
                                        ac.InputEnded:Connect(
                                        function(aq)
                                            if
                                                aq.KeyCode.Name == ao or
                                                    ao == "MouseLeft" and
        ...
        function ah.New(ai, aj)
            ...
            local rightContainer =
                ...
                "Frame",
                {
                    ...
                    Position = UDim2.new(1, 0, 0.5, 0),
                    AnchorPoint = Vector2.new(1, 0.5),
                    Parent = ak.Frame.UIElements.Main,
                    ZIndex = 5
                },
                {
                    ac(
            ...
            local switchFrame, switchFunc = af(ak.Value, nil, rightContainer, nil, aj.Window.NewElements)
            switchFrame.LayoutOrder = 2

            local bindDisplay = ag(ak.Key, nil, rightContainer)
            bindDisplay.LayoutOrder = 1
            bindDisplay.AutomaticSize = Enum.AutomaticSize.None
            bindDisplay.Size = UDim2.new(0, 0, 0, 30)

            ac("UIScale", {Parent = bindDisplay, Scale = 0.95})

            local textLabel = bindDisplay.Frame.Frame.TextLabel

            local function UpdateKeybindSize()
                local textBoundsX = textLabel.TextBounds.X
                bindDisplay.Size = UDim2.new(0, 24 + textBoundsX, 0, 30)
            end

            aa.AddSignal(textLabel:GetPropertyChangedSignal("TextBounds"), UpdateKeybindSize)

            local function SetBindText(str)
                textLabel.Text = str
                UpdateKeybindSize()
            end
            ...
            function ak.Lock(am)
                ak.Locked = true
                al = false
                return ak.Frame:Lock()
            end

            function ak.Unlock(am)
                ak.Locked = false
                al = true
                return ak.Frame:Unlock()
            end

            function ak.SetKey(am, newKey)
                ak.Key = newKey
                SetBindText(newKey)
            end

            function ak.Set(am, newVal, skipCallback)
                if al then
                    if switchFunc and switchFunc.Set then
                        switchFunc.Set(nil, newVal, false)
                    end

                    ak.Value = newVal

                    if not skipCallback then
                        aa.SafeCallback(ak.Callback, newVal, ak.Key)
                    end
                end
            end

            if switchFunc and switchFunc.Set then
                switchFunc.Set(nil, ak.Value, false)
            end
            ...
            aa.AddSignal(
                ...
                function(input, processed)
                    ...
                    if not ak.Picking and al and not ak.Locked then
                        local key =
                            input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode.Name or
                            (input.UserInputType == Enum.UserInputType.MouseButton1 and "MouseLeft") or
                            (input.UserInputType == Enum.UserInputType.MouseButton2 and "MouseRight")

                        if key == ak.Key then
                            ak.Set(nil, not ak.Value)
                        end
                    end
                end
            )
            ...
            aa.AddSignal(
                ak.Frame.UIElements.Main.MouseButton1Click,
                function()
                    if al and not ak.Picking and not ak.Locked then
                        ak.Set(nil, not ak.Value)
                    end
                end
            )
            ...
            aa.AddSignal(
                bindDisplay.MouseButton1Click,
                function()
                    if al and not ak.Locked then
                        ak.Picking = true
                        SetBindText("...")

                        ad(bindDisplay.Frame.Frame, 0.2, {ImageColor3 = Color3.fromRGB(200, 200, 200)}):Play()
                        ...
                        inputConnection =
                            ...
                            function(input)
                                ...
                                if valid then
                                    ...
                                    SetBindText(ak.Key)
                                    ad(bindDisplay.Frame.Frame, 0.2, {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play(
    ...
    function a.BK()
        ...
        function ah.New(ai, aj)
            local ak = {
                ...
                Title = aj.Title or "Button Keybind",
                Desc = aj.Desc or nil,
                Key = aj.Key or "None",
                Icon = aj.Icon or "mouse-pointer-2",
            ...
            local btnIconObj = aa.Image(ak.Icon, "BtnIcon", 0, aj.Window.Folder, "Button", true, ak.IconThemed)
            btnIconObj.Parent = rightContainer
            btnIconObj.Size = UDim2.new(0, 20, 0, 20)
            btnIconObj.BackgroundTransparency = 1
            btnIconObj.LayoutOrder = 2

            if not ak.IconThemed then
                aa.AddThemeObject(btnIconObj.ImageLabel, {ImageColor3 = "Text"})
                btnIconObj.ImageLabel.ImageTransparency = 0.2
            end
            ak.UIElements.Icon = btnIconObj
            ...
            function ak.Fire()
                if al and not ak.Picking and not ak.Locked then
                    if ak.UIElements.Icon and ak.UIElements.Icon.ImageLabel then
                        ad(ak.UIElements.Icon.ImageLabel, 0.1, {ImageTransparency = 0.6}):Play()
                        task.delay(
                            0.1,
                            function()
                                ad(
                                    ak.UIElements.Icon.ImageLabel,
                                    0.2,
                                    {ImageTransparency = (ak.IconThemed and 0 or 0.2)}
                                ):Play()
                            end
                        )
                    end

                    aa.SafeCallback(ak.Callback, ak.Key)
                end
            end
    ...
    function a.J()
        ...
        function aa.New(am, an, ao, ap, aq)
            ...
            function ar.Refresh(at, au)
                ...
                for ax, ay in next, au do
                    if (ay.Type ~= "Divider") then
                        ...
                        if aq == "Dropdown" then
                            aj.AddSignal(
                                az.UIElements.TabItem.MouseButton1Click,
                                function()
                                    if az.Locked then
                                        return
                                    end
                        ...
                        elseif aq == "Menu" then
                            if not az.Locked then
                                aj.AddSignal(
                                    az.UIElements.TabItem.MouseEnter,
                                    function()
                                        al(az.UIElements.TabItem, 0.08, {ImageTransparency = .95}):Play()
                                    end
                                )
                                aj.AddSignal(
                                    az.UIElements.TabItem.InputEnded,
                                    function()
            ...
            aj.AddSignal(
                (an.UIElements.Dropdown and an.UIElements.Dropdown.MouseButton1Click or
                    an.DropdownFrame.UIElements.Main.MouseButton1Click),
                function()
                    ar:Open()
                end
            )
            ...
            aj.AddSignal(
                ...
                function(at)
                    if
                        at.UserInputType == Enum.UserInputType.MouseButton1 or
                            at.UserInputType == Enum.UserInputType.Touch
                     then
    ...
    function a.M()
        ...
        function aa.New(ak, al, am, an, ao)
            ...
            ae.AddSignal(
                aq:GetPropertyChangedSignal "TextBounds",
                function()
        ...
        function ah.New(aj, ak)
            ...
            function al.SetIcon(an, ao)
                ...
                if ao then
                    ...
                    am.ImageLabel.ImageTransparency = 0.2
                end
            end
            ...
            local function UpdateTitleSize()
                local ap = 0
                if am then
                    ap = ap - (al.IconSize + 10)
                end
                if an.Visible then
                    ap = ap - (al.IconSize + 10)
                end
                textContainer.Size = UDim2.new(1, ap, 0, 0)
            end
            ...
            local divider =
                ...
                "Frame",
                {
                    ...
                    Position = UDim2.new(0.5, 0, 0, al.HeaderSize - 1),
                    AnchorPoint = Vector2.new(0.5, 0),
                    BackgroundTransparency = 1,
                    ThemeTag = {
            ...
            function al.Open(ar)
                if al.Expandable then
                    ...
                    af(
                        ...
                        0.35,
                        {
                            Size = UDim2.new(
                                ...
                                ap.Size.X.Offset,
                                0,
                                al.HeaderSize + (ap.Content.AbsoluteSize.Y / ak.UIScale)
                            )
                        },
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
                    ...
                    af(
                        an.ImageLabel,
                        0.25,
                        {Rotation = 180, ImageTransparency = 0},
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
                    ):Play()

                    af(divider, 0.25, {BackgroundTransparency = 0.85}, Enum.EasingStyle.Quad, Enum.EasingDirection.Out):Play(

                    )

                    local themeAccent = aa.GetThemeProperty("Accent", aa.Theme)
                    if themeAccent then
                        af(an.ImageLabel, 0.2, {ImageColor3 = themeAccent}):Play()
                    end
                end
            end
            ...
            function al.Close(ar)
                if al.Expandable then
                    ...
                    af(
                        an.ImageLabel,
                        0.25,
                        {Rotation = 0, ImageTransparency = 0.5},
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
                    ):Play()

                    af(divider, 0.2, {BackgroundTransparency = 1}, Enum.EasingStyle.Quad, Enum.EasingDirection.Out):Play(

                    )

                    local themeIcon = aa.GetThemeProperty("Icon", aa.Theme)
                    if themeIcon then
                        af(an.ImageLabel, 0.2, {ImageColor3 = themeIcon}):Play()
                    end
                end
            end

            aa.AddSignal(
                ap.Top.MouseButton1Click,
                function()
                    if al.Expandable then
                        if al.Opened then
                            al:Close()
            ...
            aa.AddSignal(
                ...
                function()
                    if al.Expandable then
                        af(ap, 0.15, {ImageTransparency = 0.93}):Play()
                        if am then
                            af(am.ImageLabel, 0.15, {ImageTransparency = 0}):Play()
                        end
                    end
                end
            )
            ...
            aa.AddSignal(
                ap.Top.MouseLeave,
                function()
                    af(ap, 0.15, {ImageTransparency = 0.96}):Play()
                    if am then
                        af(am.ImageLabel, 0.15, {ImageTransparency = 0.2}):Play()
                    end
                end
            )

            aa.AddSignal(
                ap.Content.UIListLayout:GetPropertyChangedSignal "AbsoluteContentSize",
                function()
                    if al.Opened then
                        al:Open()
                    end
    ...
    function ae.New(af, ag)
        local sectionData = {
            ...
            Subtitle = ag.Subtitle or ag.Desc or nil,
            Icon = ag.Icon,
            IconThemed = ag.IconThemed,
            Sections = ag.Sections or {},
            Opened = (ag.Opened == nil and true) or ag.Opened,
            TextXAlignment = ag.TextXAlignment or "Left",
            TextSize = ag.TextSize or 18,
            Box = true,
            FontWeight = ag.FontWeight or Enum.FontWeight.SemiBold,
            TextTransparency = ag.TextTransparency or 0,
            HeaderSize = 46,
            IconSize = 20,
            Pages = {},
            SectionButtons = {},
        ...
        if #sectionData.Sections == 0 then
            return "MultiSection", {}
        end

        local iconImg
        function sectionData.SetIcon(s, icon)
            sectionData.Icon = icon or nil
            if iconImg then
                iconImg:Destroy()
            end
            if icon then
                iconImg =
                    aa.Image(
                    icon,
                    icon .. ":" .. sectionData.Title,
                    0,
                    ag.Window.Folder,
                    "Section",
                    true,
                    sectionData.IconThemed
                )
                iconImg.Size = UDim2.new(0, sectionData.IconSize, 0, sectionData.IconSize)
                iconImg.ImageLabel.ImageTransparency = 0.2
        ...
        if sectionData.Icon then
            sectionData:SetIcon(sectionData.Icon)
        end
            ...
            },
            {
                ab(
                    "UIListLayout",
                    {
                        ...
                        Padding = UDim.new(0, 2),
                        VerticalAlignment = "Center",
                        HorizontalAlignment = sectionData.TextXAlignment == "Center" and "Center" or "Left"
                    }
                )
            }
        )
        ...
        local titleLbl =
            ...
            "TextLabel",
            {
                Name = "Title",
                BackgroundTransparency = 1,
                TextXAlignment = sectionData.TextXAlignment,
                AutomaticSize = "Y",
                TextSize = sectionData.TextSize,
                TextTransparency = sectionData.TextTransparency,
                ThemeTag = {TextColor3 = "Text"},
                FontFace = Font.new(aa.Font, sectionData.FontWeight),
        ...
        local function UpdateTitleSize()
            local wReduct = 0
            if iconImg then
                wReduct = wReduct + (sectionData.IconSize + 10)
            end
            if chevron.Visible then
                wReduct = wReduct + (sectionData.IconSize + 10)
            end
            textWrapper.Size = UDim2.new(1, -wReduct, 0, 0)
        end
        ...
        local divider =
            ...
            "Frame",
            {
                Name = "Divider",
                Size = UDim2.new(1, -24, 0, 1),
                Position = UDim2.new(0.5, 0, 0, sectionData.HeaderSize - 1),
                AnchorPoint = Vector2.new(0.5, 0),
                BackgroundTransparency = 1,
        ...
        local contentHolder =
            ...
            },
            {
                ...
                ab(
                    ...
                    {
                        PaddingTop = UDim.new(0, 8),
                        PaddingBottom = UDim.new(0, ag.Window.ElementConfig.UIPadding),
                        PaddingLeft = UDim.new(0, ag.Window.ElementConfig.UIPadding),
                        PaddingRight = UDim.new(0, ag.Window.ElementConfig.UIPadding)
                    }
                )
            }
        )
        ...
        local mainFrame =
            ad(
            ag.Window.ElementConfig.UICorner,
            "Squircle",
            {
                Size = UDim2.new(1, 0, 0, 0),
                BackgroundTransparency = 1,
        ...
        aa.AddSignal(
            navList.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"),
            function()
                if navList.UIListLayout.AbsoluteContentSize.X > (navList.AbsoluteSize.X) then
                    navList.UIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Left
                else
                    navList.UIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
                end
            end
        )

        local parsed = {}
        for _, v in ipairs(sectionData.Sections) do
            table.insert(
                parsed,
                type(v) == "table" and {Name = v.Name or v[1] or "Section", Icon = v.Icon or v[2], Badge = v.Badge} or
                    {Name = v}
            )
        end
        ...
        local function Resize()
            if not sectionData.Opened then
                return
            end

            local contentH =
                contentHolder.UIListLayout.AbsoluteContentSize.Y + contentHolder.UIPadding.PaddingTop.Offset +
                contentHolder.UIPadding.PaddingBottom.Offset

            local totalH = sectionData.HeaderSize + (contentH / ag.UIScale)

            ac(mainFrame, 0.35, {Size = UDim2.new(1, 0, 0, totalH)}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play(

            )
        end

        for i, sInfo in ipairs(parsed) do
            local pName = sInfo.Name
            local pFrame =
                ab(
                "ScrollingFrame",
                {
            ...
            local pgObj = {
                UIElements = {ContainerFrame = pFrame},
                ContainerFrame = pFrame,
                Window = ag.Window,
                Tab = ag.Tab,
                NewElements = ag.Window.NewElements,
                Elements = {},
                Index = i,
                Folder = ag.Window.Folder
            }
            ...
            sectionData.Pages[pName] = pgObj

            aa.AddSignal(pFrame.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"), Resize)
            ...
            local pill =
                ...
                "Squircle",
                {
                    ...
                    ImageTransparency = (i == 1 and 0 or 1),
                    ZIndex = 1
                }
            )
            ...
            local border =
                ...
                "SquircleOutline",
                {
                    ...
                    Size = UDim2.new(1, 0, 1, 0),
                    ThemeTag = {ImageColor3 = "Text"},
                    ImageTransparency = (i == 1 and 1 or 0.8),
                    ZIndex = 2
                }
            )
            ...
            local content = {}
            if sInfo.Icon then
                local icon = aa.Image(sInfo.Icon, "Icon", 0, ag.Window.Folder, "Button", true)
                ...
                if i == 1 then
                    ...
                    aa.AddThemeObject(icon.ImageLabel, {ImageColor3 = "Text"})
                end
                icon.ImageLabel.ImageTransparency = (i == 1 and 0 or 0.4)
            ...
            local lbl =
                ...
                "TextLabel",
                {
                    ...
                    AutomaticSize = "XY",
                    ThemeTag = {TextColor3 = "Text"},
                    TextColor3 = (i == 1 and Color3.new(1, 1, 1) or nil),
                    TextTransparency = (i == 1 and 0 or 0.4),
                    LayoutOrder = 2
                }
            )
            if i ~= 1 then
                aa.AddThemeObject(lbl, {TextColor3 = "Text"})
            end
            table.insert(content, lbl)
            ...
            if sInfo.Badge then
                local badge =
                    ...
                    {
                        AutomaticSize = "XY",
                        ThemeTag = {ImageColor3 = (i == 1 and "WindowBackground" or "Accent")},
                        LayoutOrder = 3
                    },
                    {
                        ab(
                            "TextLabel",
                            {
                                Text = tostring(sInfo.Badge),
                                TextSize = 10,
                                ThemeTag = {TextColor3 = (i == 1 and "Accent" or "WindowBackground")},
                        ...
                        ab(
                            "UIPadding",
                            {Padding = UDim.new(0, 2), PaddingLeft = UDim.new(0, 5), PaddingRight = UDim.new(0, 5)}
                        )
                    }
                )
                table.insert(content, badge)
            end
            ...
            local btnContainer =
                ...
                },
                {
                    ...
                    ab(
                        "Frame",
                        {BackgroundTransparency = 1, AutomaticSize = "XY", Size = UDim2.new(0, 0, 1, 0), ZIndex = 3},
                        {
                            ab(
                                "UIListLayout",
                                {
                            ...
                            ab("UIPadding", {PaddingLeft = UDim.new(0, 16), PaddingRight = UDim.new(0, 16)}),
                            unpack(content)
                        }
                    )
                }
            ...
            local function updateVisuals(isActive, isHover)
                local pillTrans = isActive and 0 or (isHover and 0.9 or 1)
                local borderTrans = isActive and 1 or (isHover and 0.6 or 0.8)

                ac(pill, 0.2, {ImageTransparency = pillTrans}):Play()
                ac(border, 0.2, {ImageTransparency = borderTrans}):Play()

                if isActive then
                    ac(lbl, 0.2, {TextColor3 = Color3.new(1, 1, 1), TextTransparency = 0}):Play()
                else
                    local themeCol =
                        (aa.Theme and aa.GetThemeProperty("Text", aa.Theme)) or Color3.fromRGB(200, 200, 200)
                    if typeof(themeCol) == "table" then
                        themeCol = themeCol.Color
                    end
                    ac(lbl, 0.2, {TextColor3 = themeCol, TextTransparency = 0.4}):Play()
                end

                lbl.FontFace = Font.new(aa.Font, isActive and Enum.FontWeight.Bold or Enum.FontWeight.Medium)

                if sInfo.Icon then
                    local icon = btnContainer:FindFirstChild("BtnIcon", true)
                    if icon then
                        if isActive then
                            ac(icon.ImageLabel, 0.2, {ImageColor3 = Color3.new(1, 1, 1), ImageTransparency = 0}):Play()
                        else
                            local themeCol =
                                (aa.Theme and aa.GetThemeProperty("Text", aa.Theme)) or Color3.fromRGB(200, 200, 200)
                            if typeof(themeCol) == "table" then
                            ...
                            ac(icon.ImageLabel, 0.2, {ImageColor3 = themeCol, ImageTransparency = 0.4}):Play()
                        end
                    end
                end
            end

            sectionData.SectionButtons[pName] = updateVisuals

            updateVisuals(i == 1, false)

            aa.AddSignal(
                btnContainer.MouseButton1Click,
                function()
                    if sectionData.CurrentSection == pName then
                        return
                    end
                    sectionData.CurrentSection = pName

                    for k, v in pairs(sectionData.Pages) do
                        v.ContainerFrame.Visible = (k == pName)
                    end
                    for k, fn in pairs(sectionData.SectionButtons) do
                        fn(k == pName, false)
                    end

                    local btnX = btnContainer.AbsolutePosition.X - navList.AbsolutePosition.X + navList.CanvasPosition.X
                    local offset = btnX - navList.AbsoluteSize.X / 2 + btnContainer.AbsoluteSize.X / 2
                    ac(
                        navList,
                        0.3,
                        {
                            CanvasPosition = Vector2.new(offset, 0)
                        }
                    ):Play()
        ...
        sectionData.CurrentSection = parsed[1].Name
        ...
        function sectionData.Open()
            ...
            ac(divider, 0.25, {BackgroundTransparency = 0.85}, Enum.EasingStyle.Quad, Enum.EasingDirection.Out):Play()

            local themeAccent = aa.GetThemeProperty("Accent", aa.Theme)
            if typeof(themeAccent) == "table" then
                themeAccent = themeAccent.Color or Color3.fromRGB(255, 255, 255)
            end

            if themeAccent and typeof(themeAccent) == "Color3" then
                ac(chevron.Arrow, 0.2, {ImageColor3 = themeAccent}):Play()
            end
        ...
        function sectionData.Close()
            ...
            ac(divider, 0.2, {BackgroundTransparency = 1}, Enum.EasingStyle.Quad, Enum.EasingDirection.Out):Play()

            local themeIcon = aa.GetThemeProperty("Icon", aa.Theme)
            if typeof(themeIcon) == "table" then
                themeIcon = themeIcon.Color or Color3.fromRGB(255, 255, 255)
            end

            if themeIcon and typeof(themeIcon) == "Color3" then
                ac(chevron.Arrow, 0.2, {ImageColor3 = themeIcon}):Play()
            end
        ...
        aa.AddSignal(contentHolder.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"), Resize)

        aa.AddSignal(
            mainFrame.Top.MouseButton1Click,
            function()
                if sectionData.Opened then
                    sectionData.Close()
                else
                    sectionData.Open()
                end
        ...
        aa.AddSignal(
            mainFrame.Top.MouseEnter,
            function()
                ac(mainFrame, 0.15, {ImageTransparency = 0.93}):Play()
                if iconImg then
                    ac(iconImg.ImageLabel, 0.15, {ImageTransparency = 0}):Play()
                end
            end
        )
        aa.AddSignal(
            mainFrame.Top.MouseLeave,
            function()
                ac(mainFrame, 0.15, {ImageTransparency = sectionData.Box and 0.96 or 1}):Play()
                if iconImg then
                    ac(iconImg.ImageLabel, 0.15, {ImageTransparency = 0.2}):Play()
                end
            end
        )
        ...
        return sectionData.__type, sectionData.Pages
    end
    ...
    function a.Q()
        ...
        function af.New(ah, aj)
            local ak =
                ...
                {
                    Parent = aj.Parent,
                    Size = aj.ParentType ~= "Group" and UDim2.new(1, -7, 0, 7 * (aj.Columns or 1)) or
                        UDim2.new(0, 7 * (aj.Columns or 1), 0, 0),
                    BackgroundTransparency = 1
                }
            )
    ...
    function a.T()
        return {
            Elements = {
                ...
                Slider = a.load "F",
                Keybind = a.load "G",
                ToggleKeybind = a.load "TK",
                ButtonKeybind = a.load "BK",
                Input = a.load "H",
                Dropdown = a.load "K",
                Code = a.load "N",
                                        ...
                                        task.defer(
                                            function()
                                                ...
                                                if ax then
                                                    ...
                                                    warn(
                                                        "[ Saxzhub ] Failed to apply pending config for '" ..
                                                            ar.Flag .. "': " .. tostring(ay)
                                                    )
                                                end
                                            end
    ...
    function am.New(an, ao)
        local ap = {
            ...
            Selected = false,
            Visible = (an.Visible == nil) and true or an.Visible,
            Index = nil,
            LayoutOrder = an.LayoutOrder,
            OnClick = an.OnClick,
            OnSelected = an.OnSelected,
            OnDeselected = an.OnDeselected,
            Parent = an.Parent,
            UIElements = {},
            Elements = {},
            ContainerFrame = nil,
        ...
        if ap.IconShape then
            ap.TabPaddingX = 8 + (Window.UIPadding / 4)
        ...
        ap.UIElements.Main =
            ...
            "Squircle",
            {
                ...
                ImageTransparency = 1,
                Visible = ap.Visible,
                LayoutOrder = ap.LayoutOrder or ap.Index
            },
            {
                af.NewRoundFrame(
                    ap.UICorner,
        ...
        if ap.Icon then
            ...
            if not ap.IconShape then
                ...
                as.ImageLabel.ImageTransparency = not ap.Locked and 0.4 or .7
                titleWidthOffset = -22 - (Window.UIPadding / 2)
            elseif ap.IconColor then
                ...
                titleWidthOffset = -28 - (Window.UIPadding / 2)
            end
        ...
        ap.UIElements.Main.Frame.TextLabel.Size = UDim2.new(1, titleWidthOffset, 0, 0)

        ap.UIElements.BadgeContainer =
            af.NewRoundFrame(
            6,
            "Squircle",
            {
        ...
        local function RecalculateTitleSize()
            local extra = titleWidthOffset
            if ap.UIElements.BadgeContainer.Visible then
                extra = extra - ap.UIElements.BadgeContainer.AbsoluteSize.X - (Window.UIPadding / 2)
            end
            ap.UIElements.Main.Frame.TextLabel.Size = UDim2.new(1, extra, 0, 0)
        end
                    ...
                    },
                    {
                        ...
                        ah(
                            "TextLabel",
                            {
                                ...
                                TextSize = 20,
                                TextTransparency = .1,
                                Size = UDim2.new(1, titleWidthOffset, 1, 0),
        ...
        function ap.SetBadge(s, val, bgColor, textColor)
            ap.Badge = val
            if not val or val == "" then
                ap.UIElements.BadgeContainer.Visible = false
            else
                ap.UIElements.BadgeContainer.Visible = true
                ap.UIElements.BadgeContainer.TextLabel.Text = tostring(val)
                if textColor then
                    ap.UIElements.BadgeContainer.TextLabel.TextColor3 = textColor
                end
                if bgColor then
                    ap.UIElements.BadgeContainer.ImageColor3 = bgColor
                end
            end
            task.delay(0.05, RecalculateTitleSize)
        end

        if ap.Badge then
            ap:SetBadge(ap.Badge)
        else
            task.delay(0.05, RecalculateTitleSize)
        end
        ...
        function ap.Hide(s)
            ...
            if ap.Selected then
                for i, t in next, am.Tabs do
                    if t.Visible and not t.Locked and t.Index ~= ap.Index then
                        am:SelectTab(t.Index)
                        break
                    end
                end
            end
        ...
        function ap.Lock(s)
            ap.Locked = true
            ap.UIElements.Main.Frame.TextLabel.TextTransparency = 0.7
            if ap.UIElements.Icon then
                ap.UIElements.Icon.ImageLabel.ImageTransparency = 0.7
            end
        end

        function ap.Unlock(s)
            ap.Locked = false
            ap.UIElements.Main.Frame.TextLabel.TextTransparency = 0.4
            if ap.UIElements.Icon then
                ap.UIElements.Icon.ImageLabel.ImageTransparency = 0
            end
        end
        ...
        af.AddSignal(
            ...
            function()
                if ap.OnClick then
                    af.SafeCallback(ap.OnClick)
                end
                if not ap.Locked and ap.Visible then
                    am:SelectTab(aq)
                end
            end
        )
        ...
        af.AddSignal(
            ap.UIElements.Main.MouseEnter,
            function()
                if not ap.Locked and ap.Visible then
                    if not ap.Selected then
                        aj(ap.UIElements.Main.Frame, 0.15, {ImageTransparency = .98}):Play()
                        aj(ap.UIElements.Main.Outline, 0.15, {ImageTransparency = 0.8}):Play()
                    end
                    aj(
                        ap.UIElements.Main.Frame.UIPadding,
                        0.25,
                        {PaddingLeft = UDim.new(0, ap.TabPaddingX + 4)},
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
                    ):Play()
                end
        ...
        af.AddSignal(
            ...
            function()
                ...
                if not ap.Locked and ap.Visible then
                    ...
                    if not ap.Selected then
                        aj(ap.UIElements.Main.Frame, 0.25, {ImageTransparency = 1}):Play()
                        aj(ap.UIElements.Main.Outline, 0.25, {ImageTransparency = 0.9}):Play()
                    end
                end
            end
        )
        ...
        local az = a.load "T"
        az.Load(ap, ap.UIElements.ContainerFrame, az.Elements, Window, Saxzhub, nil, az, ao)
        ...
        task.spawn(
            function()
                ...
                aB =
                    af.AddSignal(
                    ap.UIElements.ContainerFrame.ChildAdded,
                    function()
                        aA.Visible = false
                        aB:Disconnect()
                    end
    ...
    function am.SelectTab(an, ao)
        if am.Tabs[ao] and not am.Tabs[ao].Locked and am.Tabs[ao].Visible then
            if am.SelectedTab and am.Tabs[am.SelectedTab] and am.Tabs[am.SelectedTab].OnDeselected then
                af.SafeCallback(am.Tabs[am.SelectedTab].OnDeselected)
            end
            ...
            for ap, aq in next, am.Tabs do
                if not aq.Locked then
                    aj(aq.UIElements.Main, 0.25, {ImageTransparency = 1}):Play()
                    aj(aq.UIElements.Main.Frame.TextLabel, 0.25, {TextTransparency = 0.45}):Play()
                    aj(aq.UIElements.Main.Outline, 0.25, {ImageTransparency = 0.9}):Play()
                    aj(aq.UIElements.Main.ActiveOutline, 0.25, {ImageTransparency = 1}):Play()

                    if aq.UIElements.Icon and not aq.IconColor then
                        aj(aq.UIElements.Icon.ImageLabel, 0.25, {ImageTransparency = 0.4}):Play()
                    end
                    if aq.UIElements.BadgeContainer then
                        aj(aq.UIElements.BadgeContainer, 0.25, {ImageTransparency = 0.4}):Play()
                        aj(aq.UIElements.BadgeContainer.TextLabel, 0.25, {TextTransparency = 0.4}):Play()
                    end
                    aq.Selected = false
                end
            end

            local active = am.Tabs[ao]

            if active.OnSelected then
                af.SafeCallback(active.OnSelected)
            end

            aj(active.UIElements.Main, 0.35, {ImageTransparency = 0.92}):Play()
            aj(active.UIElements.Main.Frame.TextLabel, 0.35, {TextTransparency = 0}):Play()
            aj(active.UIElements.Main.ActiveOutline, 0.35, {ImageTransparency = 0.5}):Play()

            if active.UIElements.Icon and not active.IconColor then
                aj(active.UIElements.Icon.ImageLabel, 0.35, {ImageTransparency = 0}):Play()
            end

            if active.UIElements.BadgeContainer then
                aj(active.UIElements.BadgeContainer, 0.35, {ImageTransparency = 0}):Play()
                aj(active.UIElements.BadgeContainer.TextLabel, 0.35, {TextTransparency = 0}):Play()
            end
            ...
            task.spawn(
                function()
                    for ar, as in next, am.Containers do
                        as.AnchorPoint = Vector2.new(0, 0.08)
                        as.Visible = false
                    end
    ...
    function a.V()
        ...
        function aa.New(ak, al, am, an, ao)
            ...
            ae.AddSignal(
                as.TextButton.MouseButton1Click,
                function()
                    if ap.Expandable then
                        if ap.Opened then
                            ap:Close()
    ...
    function a.X()
        ...
        function ae.new(ak, al, am)
            ...
            af.AddSignal(
                aq.UIListLayout:GetPropertyChangedSignal "AbsoluteContentSize",
                function()
                    aj(
                        aq,
                        .06,
            ...
            af.AddSignal(
                ap.TextButton.MouseButton1Click,
                function()
                    an:Close()
                end
            )
    ...
    function a.Y()
        ...
        return function(ar)
            local as = {
                Title = ar.Title or "Saxzhub",
                Author = ar.Author or "Tataontop05",
                Icon = ar.Icon,
            ...
            if as.Folder then
                if not isfolder("Saxzhub/" .. as.Folder) then
                    makefolder("Saxzhub/" .. as.Folder)
                end
                if not isfolder("Saxzhub/" .. as.Folder .. "/assets") then
                    makefolder("Saxzhub/" .. as.Folder .. "/assets")
                end
            ...
            if as.User then
                ...
                function as.User.Update(self, dispName, userName)
                    if aA then
                        aA.UserIcon.Frame.DisplayName.Text = dispName or aA.UserIcon.Frame.DisplayName.Text
                        aA.UserIcon.Frame.UserName.Text = userName or aA.UserIcon.Frame.UserName.Text
                    end
                end
            ...
            local b =
                typeof(as.Background) == "string" and not aF and string.match(as.Background, "^https?://.+") or nil
                ...
                if string.find(aF, "http") then
                    ...
                    if not isfile(d) then
                        local f, g =
                            ...
                            function()
                                local f =
                                    aj.Request {Url = aF, Method = "GET", Headers = {["User-Agent"] = "Roblox/Exploit"}}
                                writefile(d, f.Body)
                            end
                        )
                        if not f then
                            warn("[ Saxzhub.Window.Background ] Failed to download video: " .. tostring(g))
                            return
                        end
                    end
                    ...
                    if not f then
                        warn("[ Saxzhub.Window.Background ] Failed to load custom asset: " .. tostring(g))
                        return
                    end
                    warn "[ Saxzhub.Window.Background ] VideoFrame may not work with custom video"
                    aF = g
                end
            ...
            elseif b then
                ...
                if not isfile(d) then
                    local f, g =
                        ...
                        function()
                            local f =
                                aj.Request {Url = b, Method = "GET", Headers = {["User-Agent"] = "Roblox/Exploit"}}
                            writefile(d, f.Body)
                        end
                    )
                    if not f then
            ...
            aj.AddSignal(
                ...
                function()
                    local j = 0
                    local l =
                        as.UIElements.Main.Main.Topbar.Right.UIListLayout.AbsoluteContentSize.X / ar.Saxzhub.UIScale

                    j = as.UIElements.Main.Main.Topbar.Left.AbsoluteSize.X / ar.Saxzhub.UIScale
                    if as.Topbar.ButtonsType ~= "Default" then
                        j = j + l + as.UIPadding - 4
                    end

                    as.UIElements.Main.Main.Topbar.Center.Position =
                        UDim2.new(0, j + (as.UIPadding / ar.Saxzhub.UIScale), 0.5, 0)
                    as.UIElements.Main.Main.Topbar.Center.Size =
                        UDim2.new(1, -j - l - ((as.UIPadding * 2) / ar.Saxzhub.UIScale), 1, 0)
                end
            )
                ...
                aj.AddSignal(
                    ...
                    function()
                        as.UIElements.Main.Main.Topbar.Left.Position =
                            UDim2.new(
                            0,
                            (as.UIElements.Main.Main.Topbar.Right.AbsoluteSize.X / ar.Saxzhub.UIScale) + as.UIPadding - 4,
                            0,
                            0
                        )
                    end
            ...
            function as.CreateTopbarButton(j, l, m, p, r, u, v)
                ...
                x.Size =
                    ...
                    UDim2.new(0, as.TopBarButtonIconSize, 0, as.TopBarButtonIconSize) or
                    UDim2.new(0, 0, 0, 0)
                ...
                local B =
                    ...
                    "Squircle",
                    {
                        Size = as.Topbar.ButtonsType == "Default" and
                            UDim2.new(0, as.Topbar.Height - 16, 0, as.Topbar.Height - 16) or
                            UDim2.new(0, 14, 0, 14),
            ...
            if not aD and as.Background and typeof(as.Background) == "table" then
                ...
                as.UIElements.BackgroundGradient =
                    ...
                    "Squircle",
                    {
                        ...
                        ImageTransparency = as.Transparent and ar.Saxzhub.TransparencyValue or 0
                    },
                    {
                        l
                    }
            ...
            function as.UpdateTitle(self, newTitle, newAuthor)
                if newTitle then as:SetTitle(newTitle) end
                if newAuthor then as:SetAuthor(newAuthor) end
            end
            ...
            function as.SetBackgroundTransparency(l, m)
                ...
                ar.Saxzhub.TransparencyValue = p
            ...
            as:CreateTopbarButton(
                "Fullscreen",
                "maximize",
                function()
                    as:ToggleFullscreen()
                end,
                (as.Topbar.ButtonsType == "Default" and 998 or 999),
                nil,
            ...
            as:CreateTopbarButton(
                ...
                (as.Topbar.ButtonsType == "Default" and 997 or 998),
                nil,
            ...
            function as.Close(p)
                ...
                ar.Saxzhub:ToggleAcrylic(false)
                ...
                function r.Destroy(u)
                    task.spawn(
                        function()
                            ...
                            as.Destroyed = true
                            task.wait(0.4)
                            ar.Saxzhub.ScreenGui:Destroy()
                            ar.Saxzhub.NotificationGui:Destroy()
                            ar.Saxzhub.DropdownGui:Destroy()
                            ar.Saxzhub.TooltipGui:Destroy()
            ...
            function as.ToggleTransparency(p, r)
                as.Transparent = r
                ar.Saxzhub.Transparent = r

                as.UIElements.Main.Background.ImageTransparency = r and ar.Saxzhub.TransparencyValue or 0
            ...
            function as.GetUIScale(p, r)
                return ar.Saxzhub.UIScale
            end

            function as.SetUIScale(p, r)
                ar.Saxzhub.UIScale = r
                al(ar.Saxzhub.UIScaleObj, .2, {Scale = r}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                return as
            end
            ...
            if as.OpenButtonMain and as.OpenButtonMain.Button then
                aj.AddSignal(
                    as.OpenButtonMain.Button.TextButton.MouseButton1Click,
                    function()
                        as:Open()
                    end
                )
            ...
            local p = a.load "U"
            local r = a.load "V"
            local u = p.Init(as, ar.Saxzhub, ar.Saxzhub.TooltipGui)
            u:OnChange(
                function(v)
                    as.CurrentTab = v
                end
            ...
            function as.Tab(v, x)
                ...
                return u.New(x, ar.Saxzhub.UIScale)
            end

            function as.SidebarButton(v, btnProps)
                local props = btnProps or v
                local title = props.Title or "Button"
                local icon = props.Icon
                local callback = props.Callback

                local sBtn = aj.NewRoundFrame(as.UICorner - (as.UIPadding / 2), "Squircle", {
                    Size = UDim2.new(1, -7, 0, 36),
                    BackgroundTransparency = 1,
                    ImageTransparency = 1,
                    ThemeTag = {ImageColor3 = "TabBackground"},
                ...
                local iconOff = 0
                if icon then
                    local ico = aj.Image(icon, title, 0, as.Folder, "SidebarButton", true)
                    ico.Size = UDim2.new(0, 18, 0, 18)
                    ico.Position = UDim2.new(0, 10, 0.5, 0)
                    ico.AnchorPoint = Vector2.new(0, 0.5)
                    ico.ImageLabel.ImageTransparency = 0.4
                    ico.Parent = sBtn
                    iconOff = 26
                end
                ...
                local lbl = ak("TextLabel", {
                    Text = title,
                    Size = UDim2.new(1, -iconOff - 24, 1, 0),
                    Position = UDim2.new(0, 12 + iconOff, 0, 0),
                    BackgroundTransparency = 1,
                    TextSize = 15,
                    FontFace = Font.new(aj.Font, Enum.FontWeight.Medium),
                ...
                aj.AddSignal(sBtn.MouseEnter, function()
                    al(sBtn, 0.2, {ImageTransparency = 0.95}):Play()
                    al(lbl, 0.2, {TextTransparency = 0}):Play()
                    if icon then
                         al(sBtn:FindFirstChildOfClass("Frame").ImageLabel, 0.2, {ImageTransparency = 0}):Play()
                    end
                end)
                aj.AddSignal(sBtn.MouseLeave, function()
                    al(sBtn, 0.2, {ImageTransparency = 1}):Play()
                    al(lbl, 0.2, {TextTransparency = 0.4}):Play()
                    if icon then
                         al(sBtn:FindFirstChildOfClass("Frame").ImageLabel, 0.2, {ImageTransparency = 0.4}):Play()
                    end
                end)
                aj.AddSignal(sBtn.MouseButton1Click, function()
                    if callback then
                        aj.SafeCallback(callback)
                    end
                end)
            ...
            function as.Dialog(x, B)
                ...
                local function CheckButtonsOverflow()
                    ...
                    local R = J.AbsoluteContentSize.X / ar.Saxzhub.UIScale
                    local S = L.AbsoluteSize.X / ar.Saxzhub.UIScale
                    ...
                    if R > S then
                        ...
                        if T > 0 then
                            ...
                            for W, X in ipairs(M) do
                                local Y = X.AbsoluteSize.X / ar.Saxzhub.UIScale
                                if Y < V then
                                    V = Y
                                    U = X
                                end
            ...
            as:CreateTopbarButton(
                ...
                (as.Topbar.ButtonsType == "Default" and 999 or 997),
                nil,
            ...
            aj.AddSignal(
                ...
                function(x)
                    if
                        x.UserInputType == Enum.UserInputType.MouseMovement or
